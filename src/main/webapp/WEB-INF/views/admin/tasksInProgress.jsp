...
<div class="layout">
    ...
    <div class="main">
        <div class="page-header">
            ...
            <p>All tasks currently being worked on by organizations.</p>
        </div>
        <div class="card">
                ...
                <table>
                    ...
                    <c:choose>
                        <c:when test="${empty tasks}">
                            <tr><td colspan="5" style="text-align:center;color:#888;">No tasks currently in progress.</td></tr>
                        </c:when>
                        <c:otherwise>
...
<script>
    initializeDetailsForm('${pageContext.request.contextPath}/admin/tasks', 'updateTask', 'deleteTask', 'Task Details');
    ...
    function showTaskDetails(row) {
        ...
        var content = 
            ...
            createFormField('Status', '', 'In Progress', 'text', true) +
            createFormField('Description', 'description', d.description, 'textarea') +
            createFormField('Assigned To', '', d.org, 'text', true) +
            createFormField('Started At', '', d.created, 'text', true);
