...
<div class="layout">
 ...
 <table>
 <thead>
 <tr><th>#</th><th>Title</th><th>Description</th><th>Handled By</th><th>Status</th><th>Started</th></tr>
 </thead>
 <tbody>
 <c:choose>
 <c:when test="${empty tasks}">
 <tr><td colspan="6" style="text-align:center;color:#888;">No tasks in progress.</td></tr>
 </c:when>
 <c:otherwise>
